...
export function Projects() {
  ...
  const articles = [
    {
      id: 1,
      title: "Around the world in 100 pixels - Game with Three.js",
      link: "game/index.html"
    },
    {
      id: 2,
      title: "FarmEasy - Web App",
      link: "https://farmeasy-ch.netlify.app/login"
    },
    {
      id: 3,
      title: "Complex Analysis Models (Not deplyed yet",
      link: "#"
    },
    {
      id: 4,
      title: "Data Center Design with Three.js (Not deplyed yet)",
      link: "#"
    },
  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-6xl">
      <motion.div
        ...
        className="mb-10"
      >
        <SectionTitle title="Live Deployements" />
